...
const ReadPost = ({ data }) => {
  ...
  return (
    <>
      ...
      <div className="item-card w-96 bg-slate-500 m-5 p-5 rounded-xl hover:shadow-xl hover:shadow-slate-400 hover:-translate-y-5 transition duration-500 ease-in-out flex flex-col">
